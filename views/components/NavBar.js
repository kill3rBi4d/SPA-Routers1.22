let NavBar = {
    render: async () => {
        ...
        <div class="navbar-center">
            ...
            <a class="navbar-item ripple" href="/#/explore" id="create-post">
                <img src="/src/props/icons/explore.svg" class="fas" id="explore-ico" />
            </a>
            <a class="navbar-item ripple plus" id="menu-toggle" href="/#/createpost">
            ...
            <a class="navbar-item ripple" href="/#/chats">

            ...
            snapshot.forEach(function(snap){
                ...
                <div class="post-card">
                    ...
                    <div class="post-content">
                        ...
                        <a href="/#/explore-post" class="img-frame" id="img-frame-${val.name}">
                ...
                document.getElementById('explore-post-view').style.display =  parsedURL == '/explore-post' ? 'flex' : 'none'
                imgFrame.addEventListener('click', () => {
                    document.getElementById('explore-post-view').style.backgroundImage = `url(${val.image})`
                })
